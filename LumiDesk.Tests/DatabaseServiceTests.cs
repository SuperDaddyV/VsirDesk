...
public class DatabaseServiceTests
{
    ...
    public async Task InitializeAsync_ShouldInitializeAllDefaultSettings()
    {
        ...
        var expectedKeys = new[] { "AutoLocation", "City", "DatabaseVersion", "Hotkey", "PanelWidth", "Startup", "Theme", "TopMost", "WeatherApiHost", "WeatherApiKey", "WidgetLayout", "WindowOpacity" };
