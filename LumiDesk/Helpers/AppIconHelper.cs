...
{
    private const string PackUri = "pack://application:,,,/icon/lumidesk1-removebg-preview.ico";
    private const string RelativeFilePath = "icon/lumidesk1-removebg-preview.ico";
